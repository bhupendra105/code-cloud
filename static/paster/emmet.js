!(function (e) {
  ...
  if ("object" == typeof exports && "undefined" != typeof module)
    module.exports = val;
  if ("function" == typeof define && define.amd) define("emmet", [], val);
  {
    var f;
  ...
  return (function outer(modules, cache, entry) {
  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
                ...
                if (direction == "in") {
                  ...
                  if (lastMatch.type == "tag" && !lastMatch.close) {
                    ...
                    if (lastMatch.range.equal(lastMatch.outerRange)) {
                      ...
                      var narrowed = utils.narrowToNonSpace(
                        content,
                        lastMatch.innerRange
                      );
                      lastMatch = htmlMatcher.find(content, narrowed.start + 1);
                      if (
                        lastMatch &&
                        lastMatch.range.equal(sel) &&
                        lastMatch.outerRange.equal(sel)
                      ) {
                        lastMatch.range = lastMatch.innerRange;
                      }
                    }
                  ...
                  if (
                    ...
                    if (
                      lastMatch &&
                      lastMatch.range.equal(sel) &&
                      lastMatch.innerRange.equal(sel)
                    ) {
                      lastMatch.range = lastMatch.outerRange;
                    }
                  }
            ...
            function rangesForCSSRule(rule, pos) {
              ...
              var prop =
                cssEditTree.propertyFromPosition(rule, pos) || items[0];
              if (prop) {
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function startsWith(token, text, pos) {
              pos = pos || 0;
              return (
                text.charAt(pos) == token.charAt(0) &&
            ...
            function encodeToBase64(editor, imgPath, pos) {
              ...
              file.locateFile(editorFile, imgPath, function (realImgPath) {
                ...
                file.read(realImgPath, function (err, content) {
                  ...
                  b64 =
                    "data:" +
                    (actionUtils.mimeTypes[String(file.getExt(realImgPath))] ||
                      defaultMimeType) +
                    ";base64," +
                    b64;
            ...
            function decodeFromBase64(editor, filePath, data, pos) {
              ...
              filePath =
                filePath ||
                String(
                  editor.prompt("Enter path to file (absolute or relative)")
                );
              if (!filePath) {
                return false;
              }
      ...
      "action\\expandAbbreviation.js": [
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            handlers.add(
              cssGradient.expandAbbreviationHandler.bind(cssGradient)
            );
            ...
            return {
               ...
               * @return {Boolean}
               */
              expandAbbreviationWithTabAction: function (
                editor,
                syntax,
                profile
              ) {
                ...
                if (sel) {
                  ...
                  editor.createSelection(
                    replaceRange.start,
                    replaceRange.start + content.length
                  );
                  return true;
                }
          ...
          define(function (require, exports, module) {
            ...
            return {
              increment01Action: function (editor) {
                return this.incrementNumber(editor, 0.1);
              },
              ...
              incrementNumber: function (editor, step) {
                ...
                var r = actionUtils.findExpressionBounds(
                  editor,
                  function (ch, pos, content) {
              ...
              insertLineBreakOnlyAction: function (editor) {
                ...
                if (~xmlSyntaxes.indexOf(info.syntax)) {
                  ...
                  if (tag && !tag.innerRange.length()) {
                    editor.replaceContent(
                      nl + pad + utils.getCaretPlaceholder() + nl,
                      caretPos
                    );
                    return true;
                  }
                  ...
                  if (caretPos && content.charAt(caretPos - 1) == "{") {
                    ...
                    if (!hasCloseBrace) {
                      ...
                      for (
                        var i = caretPos, il = content.length, ch;
                        i < il;
                        i++
                      ) {
                        ch = content.charAt(i);
                    ...
                    // defining rule set
                    var insValue =
                      nl + pad + utils.getCaretPlaceholder() + append;
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            addAction(
              ...
              bind("base64", "encodeDecodeDataUrlAction"),
              "Encode\\Decode data:URL image"
            );
            addAction(
              "prev_edit_point",
              bind("editPoints", "previousEditPointAction"),
              "Previous Edit Point"
            );
            addAction(
              "next_edit_point",
              bind("editPoints", "nextEditPointAction"),
              "Next Edit Point"
            );
            addAction(
              "evaluate_math_expression",
              bind("evaluateMath", "evaluateMathAction"),
              "Numbers/Evaluate Math Expression"
            );
            addAction(
              "expand_abbreviation_with_tab",
              bind("expandAbbreviation", "expandAbbreviationWithTabAction"),
              { hidden: true }
            );
            addAction(
              "expand_abbreviation",
              bind("expandAbbreviation", "expandAbbreviationAction"),
              "Expand Abbreviation"
            );
            addAction(
              "insert_formatted_line_break_only",
              bind("lineBreaks", "insertLineBreakOnlyAction"),
              { hidden: true }
            );
            addAction(
              "insert_formatted_line_break",
              bind("lineBreaks", "insertLineBreakAction"),
              { hidden: true }
            );
            addAction(
              "balance_inward",
              bind("balance", "balanceInwardAction"),
              "Balance (inward)"
            );
            addAction(
              "balance_outward",
              bind("balance", "balanceOutwardAction"),
              "Balance (outward)"
            );
            addAction(
              "matching_pair",
              bind("balance", "goToMatchingPairAction"),
              "HTML/Go To Matching Tag Pair"
            );
            addAction(
              "merge_lines",
              bind("mergeLines", "mergeLinesAction"),
              "Merge Lines"
            );
            addAction(
              "reflect_css_value",
              bind("reflectCSSValue", "reflectCSSValueAction"),
              "CSS/Reflect Value"
            );
            addAction(
              "remove_tag",
              bind("removeTag", "removeTagAction"),
              "HTML/Remove Tag"
            );
            addAction(
              "select_next_item",
              bind("selectItem", "selectNextItemAction"),
              "Select Next Item"
            );
            addAction(
              "select_previous_item",
              bind("selectItem", "selectPreviousItemAction"),
              "Select Previous Item"
            );
            addAction(
              "split_join_tag",
              bind("splitJoinTag", "splitJoinTagAction"),
              "HTML/Split\\Join Tag Declaration"
            );
            addAction(
              "toggle_comment",
              bind("toggleComment", "toggleCommentAction"),
              "Toggle Comment"
            );
            addAction(
              "update_image_size",
              bind("updateImageSize", "updateImageSizeAction"),
              "Update Image Size"
            );
            addAction(
            ...
            addAction(
              "update_tag",
              bind("updateTag", "updateTagAction"),
              "HTML/Update Tag"
            );

            [1, -1, 10, -10, 0.1, -0.1].forEach(function (num) {
              var prefix = num > 0 ? "increment" : "decrement";
              var suffix = String(Math.abs(num))
                .replace(".", "")
                .substring(0, 2);
              ...
              addAction(
                actionId,
                bind("incrementDecrement", actionMethod),
                actionLabel
              );
            });
              ...
              getMenu: function (skipActions) {
                ...
                this.getList().forEach(function (action) {
                  if (
                    ...
                    ~skipActions.indexOf(action.name)
                  )
                    return;
      ...
      "action\\reflectCSSValue.js": [
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            prefs.define(
              ...
              false,
              "Support IE6/7/8 opacity notation, e.g. <code>filter:alpha(opacity=...)</code>.\
		Note that CSS3 and SVG also provides <code>filter</code> property so this option is disabled by default."
            ...
            function doCSSReflection(editor) {
              ...
              var cssRule = cssEditTree.parseFromPosition(
                outputInfo.content,
                caretPos
              );
              if (!cssRule) return;
            ...
            function getReflectedCSSName(name) {
              ...
              if (
                (name == "opacity" || name == "filter") &&
                prefs.get("css.reflect.oldIEOpacity")
              ) {
                return new RegExp(vendorPrefix + "(?:opacity|filter)$");
              } else if (
                (m = name.match(/^border-radius-(top|bottom)(left|right)/))
              ) {
                ...
                (m = name.match(/^border-(top|bottom)-(left|right)-radius/))
              ) {
                return new RegExp(
                  vendorPrefix +
                    "(?:" +
            ...
            function reflectValueParts(name, value) {
              ...
              var reVendor = /^\-(\w+)\-/;
              var propPrefix = reVendor.test(name)
            ...
            function getReflectedValue(curName, curValue, refName, refValue) {
              ...
              if (curName == "opacity" && refName == "filter") {
                return refValue.replace(
                  /opacity=[^)]*/i,
                  "opacity=" + Math.floor(parseFloat(curValue) * 100)
                );
              } else if (curName == "filter" && refName == "opacity") {
                var m = curValue.match(/opacity=([^)]*)/i);
                return m
                  ? utils.prettifyNumber(parseInt(m[1], 10) / 100)
                  : refValue;
              }
            ...
            module.exports = {
              reflectCSSValueAction: function (editor) {
                ...
                return actionUtils.compoundUpdate(
                  editor,
                  doCSSReflection(editor)
                );
              },
            ...
            handlers.add(module.exports._defaultHandler.bind(module.exports), {
              order: -1,
            });
              ...
              removeTagAction: function (editor) {
                ...
                if (tag) {
                  if (!tag.close) {
                    ...
                    /** @type Range */
                    var tagContentRange = utils.narrowToNonSpace(
                      info.content,
                      tag.innerRange
                    );
                    /** @type Range */
                    var startLineBounds = utils.findNewlineBounds(
                      info.content,
                      tagContentRange.start
                    );
                    var startLinePad = utils.getLinePadding(
                      startLineBounds.substring(info.content)
                    );
                    ...
                    editor.replaceContent(
                      utils.getCaretPlaceholder() +
                        utils.escapeText(tagContent),
                      tag.outerRange.start,
                      tag.outerRange.end
                    );
                  }
          ...
          define(function (require, exports, module) {
                  ...
                  case "string":
                    ...
                    if (attrName == "class") {
                      result = result.concat(
                        classNameRanges(
                          attrValueRange.substring(source),
            ...
            function classNameRanges(className, offset) {
              ...
              while ((ch = stream.next())) {
                if (/[\s\u00a0]/.test(ch)) {
                  result.push(
                    range(stream.start + offset, stream.pos - stream.start - 1)
                  );
                  stream.eatSpace();
                  stream.start = stream.pos;
                }
              ...
              result.push(
                range(stream.start + offset, stream.pos - stream.start)
              );
              return result;
            }
            ...
            function getRangeForHTMLItem(tag, offset, selRange, isBackward) {
              var ranges = makePossibleRangesHTML(
                tag,
                xmlParser.parse(tag),
                offset
              );
            ...
            function getOpeningTagFromPosition(html, pos) {
              ...
              if (
                html.charAt(pos) == "<" &&
                (m = html.substring(pos, html.length).match(startTag))
              ) {
              ...
              property.valueParts().forEach(function (r) {
                ...
                if (stream.match(/^[\w\-]+\(/, true)) {
                  ...
                  cssEditTree.findParts(fnBody).forEach(function (part) {
                    result.push(
                      range(
                        clone.start + stream.start + part.start,
                        part.substring(fnBody)
                      )
                    );
                  });
                }
            ...
            function findNextCSSItem(editor) {
              return findItem(
                editor,
                false,
                cssSections.locateRule.bind(cssSections),
                getRangeForNextItemInCSS
              );
            }
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function joinTag(editor, profile, tag) {
              ...
              var content = tag.open.range
                .substring(tag.source)
                .replace(/\s*>$/, slash + ">");
          ...
          define(function (require, exports, module) {
            ...
            function toggleCSSComment(editor) {
              ...
              if (!rng.length()) {
                ...
                /** @type CSSRule */
                var rule = cssEditTree.parseFromPosition(
                  info.content,
                  editor.getCaretPos()
                );
                if (rule) {
                  var property = cssItemFromPosition(
                    rule,
                    editor.getCaretPos()
                  );
                  rng = property
            ...
            function genericCommentToggle(
              ...
              function removeComment(str) {
                return str
                  .replace(
                    new RegExp(
                      "^" + utils.escapeForRegexp(commentStart) + "\\s*"
                    ),
                    function (str) {
                      caretPos -= str.length;
                      return "";
                  ...
                  .replace(
                    new RegExp(
                      "\\s*" + utils.escapeForRegexp(commentEnd) + "$"
                    ),
                    ""
                  );
              }
              ...
              // comment
              var commentRange = searchComment(
                content,
                caretPos,
                commentStart,
                commentEnd
              ...
              if (commentRange && commentRange.overlap(range)) {
                ...
                newContent =
                  ...
                  range
                    ...
                    .replace(
                      new RegExp(
                        utils.escapeForRegexp(commentStart) +
                          "\\s*|\\s*" +
                          utils.escapeForRegexp(commentEnd),
                        "g"
                      ),
                      ""
                    ) +
              ...
              if (newContent !== null) {
                ...
                editor.replaceContent(
                  editorUtils.unindent(editor, newContent),
                  range.start,
                  range.end
                );
                editor.setCaretPos(caretPos);
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function updateImageSizeHTML(editor) {
              ...
              var info = editorUtils.outputInfo(editor);
              var xmlElem = xmlEditTree.parseFromPosition(
                info.content,
                offset,
                true
              );
                  ...
                  function (size) {
                    if (size) {
                      ...
                      xmlElem.value(
                        "height",
                        size.height,
                        xmlElem.indexOf("width") + 1
                      );

                      actionUtils.compoundUpdate(
                        editor,
                        utils.extend(compoundData, {
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function updateAttributes(tag, abbrNode, ix) {
              var classNames = (abbrNode.attribute("class") || "").split(
                /\s+/g
              );
              if (ix) {
            ...
            return {
              ...
              updateTagAction: function (editor, abbr) {
                ...
                if (tag.name() != ctx.name && ctx.match.close) {
                  editor.replaceContent(
                    "</" + tag.name() + ">",
                    ctx.match.close.range.start,
                    ctx.match.close.range.end,
                    true
                  );
                }
                ...
                editor.replaceContent(
                  tag.source,
                  ctx.match.open.range.start,
                  ctx.match.open.range.end,
                  true
                );
                return true;
              },
              ...
              getUpdatedTag: function (abbr, ctx, content, options) {
                ...
                var tag = xmlEditTree.parse(
                  ctx.match.open.range.substring(content),
                  {
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            return {
               ...
               * @param {String} profile Output profile name (html, xml, xhtml)
               */
              wrapWithAbbreviationAction: function (
                editor,
                abbr,
                syntax,
                profile
      ...
      "assets\\caniuse.js": [
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            prefs.define(
              "caniuse.enabled",
              true,
              "Enable support of Can I Use database. When enabled,\
		...
		CSS properties that should be resolved"
            ...
            prefs.define(
              "caniuse.vendors",
              "all",
              "A comma-separated list vendor identifiers\
            ...
            return {
              ...
              resolvePrefixes: function (property) {
                ...
                getVendorsList().forEach(function (vendor) {
                  var vendorVesions =
                    vendorsDB[vendor].versions.slice(versions);
      ...
      "assets\\elements.js": [
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            module.exports.add(
              "element",
              function (elementName, attrs, isEmpty) {
                var ret = {
                  name: elementName,
                  is_empty: !!isEmpty,
                };
          ...
          define(function (require, exports, module) {
            ...
            HandlerList.prototype = {
              ...
              add: function (fn, options) {
                ...
                this._list.push(
                  utils.extend({}, options, { order: order, fn: fn })
                );
              },
          ...
          define(function (require, exports, module) {
            ...
            function comment(i, match) {
              return {
                ...
                range: range(
                  i,
                  typeof match == "number" ? match - i : match[0]
                ),
                type: "comment",
              };
            }
            ...
            function findClosingPair(open, matcher) {
              ...
              for (
                var pos = open.range.end, len = text.length;
                pos < len;
                pos++
              ) {
                if (matches(text, pos, "<!--")) {
            ...
            return {
              ...
              find: function (text, pos) {
                ...
                if (open) {
                  ...
                  if (close) {
                    outerRange = range.create2(
                      open.range.start,
                      close.range.end
                    );
                    innerRange = range.create2(
                      open.range.end,
                      close.range.start
                    );
                  } else {
                    outerRange = innerRange = range.create2(
                      open.range.start,
                      open.range.end
                    );
                  }
                  ...
                  return {
                    ...
                    range:
                      !innerRange.length() || !innerRange.cmp(pos, "lte", "gte")
                        ? outerRange
                        : innerRange,
                    content: function () {
          ...
          define(function (require, exports, module) {
            ...
            OutputProfile.prototype = {
              ...
              allowCompactBoolean: function () {
                return (
                  this.compact_bool && prefs.get("profile.allowCompactBoolean")
                );
              },
            };
            ...
            function createProfile(name, options) {
              return (profiles[name.toLowerCase()] = new OutputProfile(
                options
              ));
            }
            ...
            return {
              ...
              create: function (name, options) {
                if (arguments.length == 2) return createProfile(name, options);
                // create profile object only
                else
                  return new OutputProfile(
                    utils.defaults(name || {}, defaultProfile)
                  );
              },
          ...
          define(function (require, exports, module) {
            ...
            Range.prototype = {
              ...
              cmp: function (loc, left, right) {
                ...
                return (
                  cmp(this.start, a, left || "<=") &&
                  cmp(this.end, b, right || ">")
                );
              },
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function normalizeCaretPlaceholder(text) {
              return utils.replaceUnescapedSymbol(
                text,
                "|",
                utils.getCaretPlaceholder()
              );
            ...
            utils.extend(exports, {
              ...
              getMatchedResource: function (node, syntax) {
                return (
                  resolvers.exec(null, utils.toArray(arguments)) ||
              ...
              hasSyntax: function (syntax) {
                return (
                  syntax in this.getVocabulary(VOC_USER) ||
              ...
              getSection: function (name) {
                ...
                var data = cache[name],
                  subsections = utils.toArray(arguments, 1),
                  key;
              ...
              getAllSnippets: function (syntax) {
                ...
                if (!cache[cacheKey]) {
                  ...
                  do {
                    ...
                    ["snippets", "abbreviations"].forEach(function (
                      sectionName
                    ) {
                      var stackItem = {};
            ...
            StringStream.prototype = {
              ...
              match: function (pattern, consume, caseInsensitive) {
                if (typeof pattern == "string") {
                  ...
                  if (
                    cased(this.string).indexOf(cased(pattern), this.pos) ==
                    this.pos
                  ) {
            ...
            return {
              ...
              extract: function (text, options) {
                ...
                if (options.replaceCarets) {
                  text = text.replace(
                    new RegExp(
                      utils.escapeForRegexp(utils.getCaretPlaceholder()),
                      "g"
                    ),
                    "${0:cursor}"
                  );
                ...
                while ((ch = stream.next())) {
                  ...
                  if (ch == "$") {
                    ...
                    if ((m = stream.match(/^[0-9]+/))) {
                      ...
                      var placeholder = obj.token.substring(
                        obj.group.length + 2,
                        obj.token.length - 1
                      );
              ...
              upgrade: function (node, offset) {
                ...
                var options = {
                  tabstop: function (data) {
                    ...
                    if (data.placeholder)
                      return (
                        "${" + (group + offset) + ":" + data.placeholder + "}"
                      );
                    else return "${" + (group + offset) + "}";
                  },
                };
                ...
                var tsOptions = {
                  tabstop: function (data) {
                    ...
                    if (data.placeholder) {
                      ...
                      var placeholder = that.processText(
                        data.placeholder,
                        tsOptions
                      );
          ...
          define(function (require, exports, module) {
            ...
            EditContainer.prototype = {
              ...
              _updateSource: function (value, start, end) {
                ...
                var r = range.create(
                  start,
                  typeof end === "undefined" ? 0 : end - start
                );
              ...
              getAll: function (name) {
                ...
                return this.list().filter(function (attribute, i) {
                  return (
                    ~indexes.indexOf(i) || ~names.indexOf(attribute.name())
                  );
                });
              },
              ...
              nameRange: function (isAbsolute) {
                return range.create(
                  this._positions.name + (isAbsolute ? this.options.offset : 0),
                  this.name()
                );
              },
              ...
              range: function (isAbsolute) {
                return range.create(
                  isAbsolute ? this.options.offset : 0,
                  this.valueOf()
                );
              },
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function trimWhitespaceInRange(rng, text, mask) {
              mask =
                mask ||
                WHITESPACE_REMOVE_FROM_START | WHITESPACE_REMOVE_FROM_END;
              text = rng.substring(text);
              var m;
              if (
                mask & WHITESPACE_REMOVE_FROM_START &&
                (m = text.match(reSpaceStart))
              ) {
                rng.start += m[0].length;
              }

              if (
                mask & WHITESPACE_REMOVE_FROM_END &&
                (m = text.match(reSpaceEnd))
              ) {
                rng.end -= m[0].length;
              }
            ...
            function consumeSingleProperty(it, text) {
              ...
              return {
                ...
                value: trimWhitespaceInRange(
                  value,
                  text,
                  WHITESPACE_REMOVE_FROM_START |
                    (end ? WHITESPACE_REMOVE_FROM_END : 0)
                ),
            ...
            function findParts(str) {
              ...
              while ((ch = stream.next())) {
                if (ch == '"' || ch == "'") {
                  ...
                  if (sep.test(ch)) {
                    result.push(
                      range(stream.start, stream.current().length - 1)
                    );
                    stream.eatWhile(sep);
                    stream.start = stream.pos;
                  }
            ...
            var CSSEditContainer = editTree.EditContainer.extend({
              initialize: function (source, options) {
                ...
                var selectorRange = range.create2(
                  currentRule.start,
                  currentRule._selectorEnd
                );
                ...
                topLevelRules.forEach(function (r) {
                  consumeProperties(
                    that,
                    source.substring(sectionOffset, r.start),
                    sectionOffset
                  );
                  var opt = utils.extend({}, that.options, {
                    offset: r.start + that.options.offset,
                  });
                ...
                consumeProperties(
                  this,
                  source.substring(sectionOffset, currentRule.end - 1),
                  sectionOffset
                );
                this._saveStyle();
              },
              ...
              _saveStyle: function () {
                ...
                this.list().forEach(function (p) {
                  ...
                  p.styleSeparator = source.substring(
                    p.nameRange().end,
                    p.valuePosition()
                  );
                  ...
                  p.styleSeparator = p.styleSeparator.replace(
                    /\/\*.*?\*\//g,
                    ""
                  );
               ...
               */
              valueRange: function (isAbsolute) {
                return range.create2(
                  this.valuePosition(isAbsolute),
                  this._pos(this.valueOf().length, isAbsolute) - 1
                );
              },
              ...
              add: function (name, value, pos) {
                ...
                var nameToken = editTree.createToken(
                  start + styles.styleBefore.length,
                  name
                );
                var valueToken = editTree.createToken(
                  nameToken.end + styles.styleSeparator.length,
                  value
                );

                var property = new CSSEditElement(
                  this,
                  nameToken,
                  valueToken,
                ...
                this._updateSource(
                  property.styleBefore + property.toString(),
                  start
                );
            ...
            var CSSEditElement = editTree.EditElement.extend({
              ...
              value: function (val) {
                ...
                if (isUpdating && this.isIncomplete()) {
                  ...
                  this.parent._updateSource(
                    this.styleSeparator,
                    range(this.valueRange().start, 0)
                  );
                }

                var value = this.constructor.__super__.value.apply(
                  this,
                  arguments
                );
                if (isUpdating) {
              ...
              valueOf: function () {
                return (
                  this.name() + this.styleSeparator + this.value() + this.end()
                );
              },
            });
            ...
            return {
              ...
              propertyFromPosition: function (css, pos) {
                ...
                var cssRule =
                  typeof css === "string"
                    ? this.parseFromPosition(css, pos, true)
                    : css;
                if (cssRule) {
          ...
          define(function (require, exports, module) {
            ...
            var XMLEditContainer = editTree.EditContainer.extend({
                ...
                tokens.forEach(function (token) {
                  ...
                  switch (token.type) {
                    ...
                    case "attribute":
                      ...
                      if (attrToken) {
                        this._children.push(
                          new XMLEditElement(this, attrToken)
                        );
                      }
                    ...
                    case "string":
                      this._children.push(
                        new XMLEditElement(this, attrToken, token)
                      );
                      attrToken = null;
                      break;
                  }
              ...
              _saveStyle: function () {
                ...
                this.list().forEach(function (p) {
                  ...
                  if (p.valuePosition() !== -1) {
                    p.styleSeparator = source.substring(
                      p.namePosition() + p.name().length,
                      p.valuePosition() - p.styleQuote.length
                    );
                  }
              ...
              add: function (name, value, pos) {
                ...
                var attribute = new XMLEditElement(
                  this,
                  editTree.createToken(start + styles.styleBefore.length, name),
                  editTree.createToken(
                    start +
                      styles.styleBefore.length +
                      name.length +
                      styles.styleSeparator.length,
                    value
                  )
                );
                ...
                this._updateSource(
                  attribute.styleBefore + attribute.toString(),
                  start
                );
            ...
            var XMLEditElement = editTree.EditElement.extend({
              initialize: function (parent, nameToken, valueToken) {
                ...
                this._value = value;
                this._positions.value = valueToken
                  ? valueToken.start + quote.length
                  : -1;
              },
            ...
            return {
              ...
              extractTag: function (content, pos, isBackward) {
                ...
                var match = function (pos) {
                  ...
                  if (
                    content.charAt(pos) == "<" &&
                    (m = content.substr(pos, maxLen).match(startTag))
                  )
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function bemParse(item) {
              if (abbreviationUtils.isSnippet(item)) return item;
              ...
              var classNames = normalizeClassName(
              ...
              if (!item.__bem.block) {
                reBlockName = /^[a-z]/i;
                item.__bem.block =
                  utils.find(classNames, function (name) {
                    return reBlockName.test(name);
                  }) || "";
              }
            ...
            function normalizeClassName(className) {
              ...
              if (shortSymbol) {
                var re = new RegExp(
                  "\\s(" + utils.escapeForRegexp(shortSymbol) + "+)",
                  "g"
                );
                className = className.replace(re, function (str, p1) {
                  return (
                    " " + utils.repeatString(getSeparators().element, p1.length)
                  );
                });
              }
          ...
          define(function (require, exports, module) {
            ...
            function shouldBreakChild(node, profile) {
              ...
              return (
                ...
                shouldAddLineBreak(node.children[0], profile)
              );
            }
            ...
            function shouldFormatInline(node, profile) {
              ...
              return !!utils.find(node.children, function (child) {
                if (child.isTextNode() || !abbrUtils.isInline(child))
                  nodeCount = 0;
                else if (abbrUtils.isInline(child)) nodeCount++;
            ...
            function processSnippet(item, profile) {
              ...
              if (
                ...
                profile.tag_nl !== false &&
                shouldAddLineBreak(item, profile)
              ) {
            ...
            function processTag(item, profile) {
              ...
              if (profile.tag_nl !== false) {
                var forceNl =
                  profile.tag_nl === true &&
                  (profile.tag_nl_leaf || item.children.length);
                if (!forceNl) {
                  var forceIndentTags =
                    prefs.getArray("format.forceIndentationForTags") || [];
                ...
                if (!item.isTextNode()) {
                  if (shouldAddLineBreak(item, profile)) {
                    ...
                    if (
                      !isVeryFirstChild(item) &&
                      (!abbrUtils.isSnippet(item.parent) || item.index())
                    )
                      item.start = nl + item.start;

                    if (
                      abbrUtils.hasBlockChildren(item) ||
                    ...
                    if (
                      abbrUtils.hasTagsInContent(item) ||
                      (forceNl && !item.children.length && !isUnary)
                    )
                      item.start += nl + indent;
                  } else if (
                    abbrUtils.isInline(item) &&
                    hasBlockSibling(item) &&
                    !isVeryFirstChild(item)
                  ) {
                    item.start = nl + item.start;
                  } else if (
                    abbrUtils.isInline(item) &&
                    shouldBreakInsideInline(item, profile)
                  ) {
                    item.end = nl + item.end;
                  }
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function processTag(item, profile) {
              ...
              item.start = utils.replaceSubstring(
                item.start,
                start,
                item.start.indexOf(placeholder),
                placeholder
              );
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function processTag(item, profile) {
              ...
              item.end = utils.replaceSubstring(
                item.end,
                end,
                item.end.indexOf(placeholder),
                placeholder
              );
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function processTagContent(item) {
              ...
              var content = tabStops.replaceVariables(
                item.content,
                function (str, name) {
          ...
          define(function (require, exports, module) {
            ...
            return {
              ...
              composeList: function (syntax, profileName, additionalFilters) {
                ...
                var filters = list(
                  profileName.filters ||
                    resources.findItem(syntax, "filters") ||
                    basicFilters
                );
		...
		see <a href="http://docs.emmet.io/abbreviations/lorem-ipsum/">docs</a>.'
            ...
            function paragraph(lang, wordCount, startWithCommon) {
              ...
              while (totalWords < wordCount) {
                words = sample(
                  data.words,
                  Math.min(randint(2, 30), wordCount - totalWords)
                );
                totalWords += words.length;
                insertCommas(words);
                result.push(sentence(words));
              ...
              preprocessor: function (tree) {
                ...
                tree.findAll(function (node) {
                  if (node._name && (match = node._name.match(re))) {
                    ...
                    var lang =
                      match[1] || prefs.get("lorem.defaultLang") || "en";
                    ...
                    node.data(
                      "forceNameResolving",
                      node.isRepeating() || node.attributeList().length
                    );
      ...
      "parser\\abbreviation.js": [
          ...
          define(function (require, exports, module) {
            ...
            AbbreviationNode.prototype = {
              ...
              attribute: function (name, value) {
                ...
                return (
                  utils.find(this.attributeList(), function (attr) {
                    return attr.name == name;
                  }) || {}
                ).value;
              },
              ...
              valueOf: function () {
                ...
                var innerContent = this.children
                  .map(function (child) {
              ...
              deepestChild: function () {
                ...
                while (deepestChild.children.length) {
                  deepestChild =
                    deepestChild.children[deepestChild.children.length - 1];
                }
              ...
              var consumeAbbr = function () {
                ...
                stream.eatWhile(function (c) {
                  ...
                  if (c == "+") {
                    ...
                    stream.next();
                    var isMarker =
                      stream.eol() || ~"+>^*".indexOf(stream.peek());
                    stream.backUp(1);
                    return isMarker;
                  }
            ...
            function splitAttributes(attrSet) {
              ...
              var stream = stringStream(attrSet),
                ch;
              while ((ch = stream.next())) {
                if (ch == " ") {
            ...
            function unroll(node) {
              for (
                var i = node.children.length - 1, j, child, maxCount;
                i >= 0;
                i--
              ) {
            ...
            function isAllowedChar(ch) {
              ...
              return (
                (charCode > 64 && charCode < 91) || // uppercase letter
                (charCode > 96 && charCode < 123) || // lowercase letter
                (charCode > 47 && charCode < 58) || // number
                specialChars.indexOf(ch) != -1
              ); // special character
            }
            ...
            return {
              ...
              expand: function (abbr, options) {
                ...
                var filtersList = filters.composeList(
                  options.syntax,
                  p,
                  data[1]
                );
        ...
        },
        {
          ...
          "./processor/pastedContent": "parser\\processor\\pastedContent.js",
            ...
            return {
              ...
              postprocessor: function (tree, options) {
                ...
                tree.findAll(function (item) {
                  ...
                  var pastedContent = utils.trim(
                    pc.pastedContent(item) || options.pastedContent
                  );
                  if (pastedContent) {
            ...
            function insertPastedContent(node, content, overwrite) {
              ...
              if (nodesWithPlaceholders.length) {
                nodesWithPlaceholders.forEach(function (item) {
                  item.content = replaceOutputPlaceholders(
                    item.content,
                    content
                  );
                  item._attributes.forEach(function (attr) {
                ...
                if (overwrite) {
                  ...
                  deepest.content = abbrUtils.insertChildContent(
                    deepest.content,
                    content
                  );
                }
            ...
            return {
              ...
              preprocessor: function (tree, options) {
                if (options.pastedContent) {
                  var lines = utils
                    .splitByLines(options.pastedContent, true)
                    .map(utils.trim);
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
              ...
              if (type == "openTag") {
                ...
                if (curState.context) {
                  if (curState.context.tagName != tagName) {
                    ...
                    err =
                      !curState.context || curState.context.tagName != tagName;
                  }
                } else {
                  err = true;
                }
            ...
            function maybePopContext(nextTagName) {
              ...
              while (true) {
                ...
                if (
                  ...
                  !Kludges.contextGrabbers[parentTagName].hasOwnProperty(
                    nextTagName
                  )
                ) {
                  return;
            ...
            function attribute(type) {
              ...
              return type == "endTag" || type == "selfcloseTag"
                ? pass()
                : cont();
            }
            ...
            return utils.extend(module.exports, {
              ...
              _read: function (params, callback) {
                if (isURL(params.path)) {
                  var req = _transport[
                    /^https:/.test(params.path) ? "https" : "http"
                  ]
                    .get(params.path, function (res) {
                      var bufs = [];
                      var totalLength = 0;
                      var finished = false;
                      res
      ...
      "resolver\\css.js": [
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            var descTemplate = template(
              "A comma-separated list of CSS properties that may have " +
            ...
            var descAddonTemplate = template(
              "A comma-separated list of <em>additional</em> CSS properties " +
            ...
            Object.keys(props).forEach(function (k) {
              prefs.define(
                "css." + k + "Properties",
                props[k],
                descTemplate({ vendor: k })
              );
              prefs.define(
                "css." + k + "PropertiesAddon",
                "",
                descAddonTemplate({ vendor: k })
              );
            });
            ...
            function isValidKeyword(keyword) {
              return ~prefs
                .getArray("css.keywords")
                .indexOf(getKeyword(keyword));
            }
            ...
            function formatProperty(property, syntax) {
              ...
              property =
                property.substring(0, ix).replace(/\s+$/, "") +
                getSyntaxPreference("valueSeparator", syntax) +
                utils.trim(property.substring(ix + 1));

              return property.replace(
                /\s*;\s*$/,
                getSyntaxPreference("propertyEnd", syntax)
              );
            }
            ...
            function resolvePrefixedValues(snippetObj, isImportant, syntax) {
              ...
              parts.forEach(function (p) {
                ...
                (findVendorPrefixes(partValue) || []).forEach(function (
                  prefix
                ) {
                  if (!lookup[prefix]) {
                  ...
                  lookup[prefix] = utils.replaceSubstring(
                    lookup[prefix],
                    "-" + prefix + "-" + partValue,
                    p
                  );
              ...
              return prefixes.map(function (prefix) {
                return transformSnippet(
                  snippetObj.name + ":" + lookup[prefix],
                  isImportant,
                  syntax
                );
              });
            ...
            module.exports = {
              ...
              findValuesInAbbreviation: function (abbr, syntax) {
                ...
                while (
                  ~property.indexOf("-") &&
                  !resources.findSnippet(syntax, property)
                ) {
              ...
              parseValues: function (str) {
                ...
                while ((ch = stream.next())) {
                  if (ch == "$") {
                    ...
                    if (
                      isValidKeyword(utils.last(values)) ||
              ...
              extractValues: function (abbr) {
                ...
                return {
                  property: abbr
                    .substring(0, abbr.length - abbrValues.length)
                    .replace(/-$/, ""),
              ...
              normalizeValue: function (value, property) {
                ...
                return value.replace(
                  /^(\-?[0-9\.]+)([a-z]*)$/,
                  function (str, val, unit) {
                    if (
                      !unit &&
                      (val == "0" || ~unitlessProps.indexOf(property))
                    )
                      return val;
                    ...
                    if (!unit)
                      return (
                        val.replace(/\.$/, "") +
                        prefs.get(
                          ~val.indexOf(".") ? "css.floatUnit" : "css.intUnit"
                        )
                      );
              ...
              expand: function (abbr, value, syntax) {
                syntax = syntax || "css";
                var autoInsertPrefixes = prefs.get(
                  syntax + ".autoInsertVendorPrefixes"
                );
                ...
                if (!snippet && prefs.get("css.fuzzySearch")) {
                  ...
                  snippet = resources.fuzzyFindSnippet(
                    syntax,
                    abbrData.property,
                ...
                var prefixes =
                  abbrData.prefixes == "all" ||
                  (!abbrData.prefixes && autoInsertPrefixes)
                    ? findInternalPrefixes(
                        snippetObj.name,
                        autoInsertPrefixes && abbrData.prefixes != "all"
                      )
                    : abbrData.prefixes;
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            function getPropertiesForGradient(gradients, property) {
              ...
              if (
                prefs.get("css.gradient.fallback") &&
                ~propertyName.toLowerCase().indexOf("background")
              ) {
                props.push({
                  name: "background-color",
                  value:
                    "${1:" + gradients[0].gradient.colorStops[0].color + "}",
                });
              }
            ...
            function insertGradientsIntoCSSValue(gradients, value, options) {
              ...
              gradients.reverse().forEach(function (item, i) {
                var suffix =
                  !i && options.placeholder ? options.placeholder : "";
                var str = options.oldWebkit
                  ? item.gradient.stringifyOldWebkit(options)
                  : item.gradient.stringify(options);
                value = utils.replaceSubstring(
                  value,
                  str + suffix,
                  item.matchedPart
                );
            ...
            function similarPropertyNames(property) {
              ...
              var similarProps = (
                cssResolver.vendorPrefixes(property) || []
              ).map(function (prefix) {
            ...
            function pasteGradient(property, gradients) {
              ...
              // gradient definition
              rule
                .getAll(similarPropertyNames(property))
              ...
              if (alignVendor) {
                ...
                if (before != property.styleBefore) {
                  ...
                  rule._updateSource(
                    before,
                    fullRange.start,
                    fullRange.start + property.styleBefore.length
                  );
                ...
                if (sep != property.styleSeparator) {
                  rule._updateSource(
                    sep,
                    property.nameRange().end,
                    property.valueRange().start
                  );
              ...
              if (alignVendor) {
                ...
                var valuePads = utils.getStringsPads(
                ...
                property.value(
                  valuePads[valuePads.length - 1] + property.value()
                );
              }
              ...
              property.value(
                insertGradientsIntoCSSValue(gradients, value, {
                  placeholder: "${2}",
                  omitDefaultDirection: omitDir,
                })
              );
            ...
            return (module.exports = {
              ...
              expandAbbreviationHandler: function (editor, syntax, profile) {
                ...
                if (gradients) {
                  ...
                  if (/[\n\r]/.test(cssProperty.value())) {
                    ...
                    var insertPos =
                      cssProperty.valueRange(true).start +
                      utils.last(gradients.gradients).matchedPart.end;
                    content = utils.replaceSubstring(content, ";", insertPos);

                    var _gradients = this.gradientsFromCSSProperty(
                      content,
                      caret
                    );
                    if (_gradients) {
                  ...
                  var resolvedName = resolvePropertyName(
                    cssProperty.name(),
                    syntax
                  );
                  if (resolvedName) {
              ...
              expandGradientOutsideValue: function (editor, syntax) {
                ...
                var gradients = this.gradientsFromCSSProperty(
                  fakeCSS,
                  fakeCSS.length - 2
                );
                if (gradients) {
                  var props = getPropertiesForGradient(
                    gradients.gradients,
                    gradients.property
                  );
                  props.push({
                    name: gradients.property.name(),
                    value: insertGradientsIntoCSSValue(
                      gradients.gradients,
                      gradients.property.value(),
                      {
                        placeholder: "${2}",
                        omitDefaultDirection: omitDir,
                      }
                  ...
                  var sep = cssResolver.getSyntaxPreference(
                    "valueSeparator",
                    syntax
                  );
                ...
                property.parent
                  ...
                  .forEach(function (prop) {
                    ...
                    if (localGradients) {
                      ...
                      var dfn =
                        localGradients[0].matchedPart.substring(localValue);
                      var prefix = "";
                      if (/^\s*\-([a-z]+)\-/.test(dfn)) {
                        prefix = RegExp.$1;
                      }
          ...
          define(function (require, exports, module) {
            ...
            function LinearGradient(dfn) {
              ...
              while ((ch = stream.next())) {
                if (stream.peek() == ",") {
                  ...
                  if (
                    !this.colorStops.length &&
                    (reDeg.test(cur) || reKeyword.test(cur))
                  ) {
            ...
            LinearGradient.prototype = {
              ...
              stringify: function (options) {
                ...
                if (
                  !options.omitDefaultDirection ||
                  !~defaultDirections.indexOf(dir)
                ) {
                  parts.unshift(dir);
                }
              ...
              stringifyOldWebkit: function () {
                ...
                colorStops.forEach(function (cs) {
                  ...
                  if (~cs.position.indexOf(".") || cs.unit == "%") {
                    cs.position =
                      parseFloat(cs.position) / (cs.unit == "%" ? 100 : 1);
                  } else {
                    throw (
                      "Can't convert color stop '" +
                      (cs.position + (cs.unit || "")) +
                      "'"
                    );
                  }
                ...
                colorStops = colorStops.map(function (cs, i) {
                  ...
                  return (
                    "color-stop(" +
                    cs.position.toFixed(2).replace(/\.?0+$/, "") +
                    ", " +
                    cs.color +
                    ")"
                  );
            ...
            function resolveDirection(dir) {
              ...
              var key = normalizeSpace(
                prefix + (top || bottom || "") + " " + (left || right || "")
              );
            ...
            return {
              ...
              parse: function (gradient) {
                ...
                if (this.isLinearGradient(gradient)) {
                  gradient = gradient.replace(/^\s*[\-a-z]+\s*\(|\)\s*$/gi, "");
                } else {
        ...
        function (require, module, exports) {
          ...
          define(function (require, exports, module) {
            ...
            var elementTypes = {
              ...
              empty: [],
              blockLevel:
                "address,applet,blockquote,button,center,dd,del,dir,div,dl,dt,fieldset,form,frameset,hr,iframe,ins,isindex,li,link,map,menu,noframes,noscript,object,ol,p,pre,script,table,tbody,td,tfoot,th,thead,tr,ul,h1,h2,h3,h4,h5,h6".split(
                  ","
                ),
              inlineLevel:
            ...
            return {
              ...
              removeElementFromCollection: function (name, collection) {
                if (collection in elementTypes) {
                  elementTypes[collection] = utils.without(
          ...
          define(function (require, exports, module) {
            ...
            return {
              ...
              hasBlockChildren: function (node) {
                return (
                  (this.hasTagsInContent(node) && this.isBlock(node)) ||
                ...
                text = tabStops.replaceVariables(
                  ...
                  function (variable, name, data) {
                    ...
                    if (name == "child") {
                      ...
                      output = utils.padString(
                        childContent,
                        utils.getLinePaddingFromPosition(text, data.start)
                      );
          ...
          define(function (require, exports, module) {
            ...
            return {
                ...
                while (true) {
                  ...
                  if (ch == "]") {
                    ...
                    if (braceCount || textCount)
                      ...
                      !abbreviationParser.isAllowedChar(ch) ||
                      (ch == ">" &&
                        utils.endsWithTag(str.substring(0, curOffset + 1)))
                    ) {
                      // found stop symbol
                      startIndex = curOffset + 1;
                      break;
              ...
              captureContext: function (editor, pos) {
                ...
                if (syntax in allowedSyntaxes) {
                  ...
                  if (tag && tag.type == "tag") {
                    ...
                    // parse attributes
                    var tagTree = xmlEditTree.parse(
                      startTag.range.substring(content)
                    );
                    if (tagTree) {
                      contextNode.attributes = tagTree
                        .getAll()
                        .map(function (item) {
                          return {
                            name: item.name(),
              ...
              findExpressionBounds: function (editor, fn) {
                ...
                while (
                  exprStart >= 0 &&
                  fn(content.charAt(exprStart), exprStart, content)
                )
                  exprStart--;
                ...
                while (
                  exprEnd < il &&
                  fn(content.charAt(exprEnd), exprEnd, content)
                )
                  exprEnd++;
              ...
              detectSyntax: function (editor, hint) {
                ...
                if (
                  syntax == "html" &&
                  (this.isStyle(editor) || this.isInlineCSS(editor))
                ) {
                  syntax = "css";
                }
              ...
              isStyle: function (editor) {
                return !!cssSections.styleTagRange(
                  editor.getContent(),
                  editor.getCaretPos()
                );
              },
              ...
              isInlineCSS: function (editor) {
                return !!cssSections.styleAttrRange(
                  editor.getContent(),
                  editor.getCaretPos()
                );
              },
          ...
          define(function (require, exports, module) {
            ...
            return {
              ...
              replaceUnescapedSymbol: function (str, symbol, replace) {
                ...
                while (i < il) {
                  if (str.charAt(i) == "\\") {
                    ...
                    str =
                      str.substring(0, i) + newValue + str.substring(i + curSl);
                    // adjust indexes
                    il = str.length;
                    i += newValue.length;
                  } else {
              ...
              replaceCounter: function (str, value, total) {
                ...
                return this.replaceUnescapedSymbol(
                  str,
                  symbol,
                  function (str, symbol, pos, matchNum) {
                    if (
                      str.charAt(pos + 1) == "{" ||
                      that.isNumeric(str.charAt(pos + 1))
                    ) {
              ...
              prettifyNumber: function (num, fraction) {
                return num
                  .toFixed(typeof fraction == "undefined" ? 2 : fraction)
                  .replace(/\.?0+$/, "");
              },
              ...
              narrowToNonSpace: function (text, start, end) {
                ...
                while (rng.start < rng.end) {
                  if (!reSpace.test(text.charAt(rng.start))) break;
            ...
            return {
              ...
              findAllRules: function (content) {
                ...
                while ((ch = stream.next())) {
                  ...
                  if (ch == "{") {
                    matchedRanges = this.matchBracesRanges(
                      content,
                      stream.pos - 1
                    );
              ...
              nestedSectionsInRule: function (rule) {
                ...
                var nestedSections = this.findAllRules(
                  rule.valueRange().substring(rule.source)
                );
                nestedSections.forEach(function (section) {
              ...
              styleTagRange: function (content, pos) {
                ...
                return (
                  tag &&
                  tag.open.name.toLowerCase() == "style" &&
          ...
          define(function (require, exports, module) {
            ...
            return {
              ...
              unindent: function (editor, text) {
                return utils.unindentString(
                  text,
                  this.getCurrentLinePadding(editor)
                );
              },
	...
	*/
            ...
            function Token(type_, index_, prio_, number_) {
              ...
              this.prio_ = prio_ || 0;
              this.number_ =
                number_ !== undefined && number_ !== null ? number_ : 0;
              ...
              evaluate: function (values) {
                ...
                for (i = 0; i < L; i++) {
                  ...
                  if (type_ === TNUMBER) {
                    ...
                    if (f.apply && f.call) {
                      if (
                        Object.prototype.toString.call(n1) == "[object Array]"
                      ) {
          ...
          define(function (require, exports, module) {
            return {
              score: function (string, abbreviation, fuzziness) {
                ...
                abbreviation_score =
                  total_character_score / abbreviation_length;
                ...
                final_score =
                  (abbreviation_score * (abbreviation_length / string_length) +
                    abbreviation_score) /
                  2;
